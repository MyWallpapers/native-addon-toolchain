...
foreach ($Required in @(
  ...
  'cli/node_modules/@mywallpaper/sdk/dist/generated/addon-manifest-validator.js',
  'cli/dist/canvas-sdk/mywallpaper-runtime.d.ts',
  'cli/dist/canvas-sdk/verify-dist-entry.mjs',
